...
sys.path.append("../../")
from quiz import calculate_simple_moving_average, estimate_volatility
...
@project_test
def test_calculate_simple_moving_average(fn=calculate_simple_moving_average):
            ...
            pd.DataFrame(
                [
                    ...
                    [167.98009915, 21.95354197, 1184.38273374, 33.47776934,
                     14.67532669],
                    [11.04680012, 18.21317125, 20.52709535, 23.35331859,
                     14.94211731]],
                dates, tickers))])
